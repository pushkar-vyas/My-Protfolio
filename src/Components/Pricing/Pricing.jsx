    ...
    <section className="pricing container section">
      ...
      <div className="pricing_container grid">
        <div className="pricing_item">
          ...
          <p className="pricing_title">A Simple option but powerful
        ...
        <div className="pricing_item best">
          ...
          <p className="pricing_title">Unlimited product including app integration and more features
          </p>
        ...
        <div className="pricing_item">
          ...
          <p className="pricing_title">A wise option for large companies and individuals
          </p>
